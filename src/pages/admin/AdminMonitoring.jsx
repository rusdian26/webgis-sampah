  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-800 mb-1">Live Monitoring Peta Wilayah</h2>
          <p className="text-slate-500 text-sm">Pantau sebaran titik penjemputan sampah warga secara real-time.</p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 text-xs font-bold text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-100">
          ...
          <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-green-500 block shadow-sm"></span> Selesai</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 relative overflow-hidden">
        ...
        <div className="absolute top-6 right-6 z-[400] bg-white/95 backdrop-blur-md p-5 rounded-2xl shadow-lg border border-slate-100/50 pointer-events-none w-56">
          ...
          <div className="text-xs text-slate-500 mt-1 font-medium">Koordinat tersimpan</div>
        </div>
      </div>
    </div>
  );
