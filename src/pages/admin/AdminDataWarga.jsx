  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-1">Direktori Data Warga</h2>
          <p className="text-gray-600 text-sm">Kelola dan pantau seluruh data request sampah warga.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          <div className="relative w-full sm:w-64">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition shadow-sm text-sm"
              value={search}
              onChange={e => setSearch(e.target.value)}
            />
          </div>
          <select 
            className="w-full sm:w-48 py-2 px-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition shadow-sm text-sm bg-white"
            value={filter}
          ...
          <table className="w-full text-left border-collapse whitespace-nowrap">
            <thead>
              <tr className="bg-gray-50 text-gray-700 border-b-2 border-gray-200">
                <th className="p-4 font-semibold">Tgl Input</th>
                ...
                <tr key={item.id} className="border-b border-gray-100 hover:bg-slate-50 transition">
                  ...
                  <td className="p-4 text-right">
                    <button 
                      ...
                      className="bg-red-50 text-red-600 hover:bg-red-600 hover:text-white border border-red-200 px-3 py-1.5 rounded-lg text-sm transition font-medium shadow-sm"
                    >
                      Hapus
                    </button>
                  </td>
