    ...
    <div className="flex h-screen bg-slate-50 font-sans text-slate-800 overflow-hidden">
      ...
      <aside className="w-64 flex-shrink-0 bg-gradient-to-b from-green-600 to-green-800 text-white flex flex-col shadow-2xl relative z-20">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 no-scrollbar">
          <div className="text-xs font-semibold text-green-200 uppercase tracking-wider mb-4 pl-3">Menu Warga</div>
        ...
        <div className="p-4 border-t border-white/10 bg-black/10">
          <div className="flex items-center gap-3 p-2 rounded-xl bg-white/5 border border-white/10">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-white truncate">Warga</p>
        ...
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm flex items-center justify-between px-8 z-10">
          ...
          <div className="flex-1 max-w-md hidden sm:block">
            <div className="relative group">
              ...
              <input 
                type="text" 
                placeholder="Cari riwayat sampah..." 
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="relative">
              ...
              >
                <img src={`https://ui-avatars.com/api/?name=Warga&background=22c55e&color=fff&rounded=true`} alt="Profile" className="w-8 h-8 rounded-full shadow-sm" />
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 animate-fade-in-up">
                  <div className="px-4 py-2 border-b border-slate-100 mb-1">
                    <p className="text-sm font-semibold text-slate-800">Warga</p>
                    <p className="text-xs text-slate-500 truncate">{user?.email || 'warga@ecowaste.com'}</p>
                  </div>
                  <button 
